...
import { setMeals } from "../slices/MealSlice";
 ...
 export const mealsAPI = createApi({
    ...
    endpoints: builder => ({
        ...
        deleteProductInMeal: builder.mutation<Meals, {mealId: string, id: string, type: string}>({
        ...
        updateProductInMeal: builder.mutation<Meals, {mealId: string, _id: string, type: string, quantity: string}>({
 ...
 export const {useFetchDayMealsQuery, useDeleteProductInMealMutation, useUpdateProductInMealMutation, useAddProductToMealMutation} = mealsAPI